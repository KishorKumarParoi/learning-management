                        ...
                        >
                            <div className='app-sidebar__logo-container group'>
                                <div className='app-sidebar__logo-wrapper'>
                                    ...
                                    />
                                    {/* <p className='app-sidebar__title'>Pidemy</p> */}
                                </div>
                                <PanelLeft className='app-sidebar__collapse-icon' size={50} />
                            </div>
                        </SidebarMenuButton>
                    </SidebarMenuItem>
                </SidebarMenu>
                                ...
                                >
                                    ...
                                    >
                                        <Link href={link.href} className='app-sidebar__nav-link'>
                                            <link.icon className={isActive ? "text-white-50" : "text-black-400"} />
