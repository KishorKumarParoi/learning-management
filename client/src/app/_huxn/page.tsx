...
const images = [
  ...
  'https://images.unsplash.com/photo-1506748686214-e9df14d4d9d0?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=MnwzNjUyOXwwfDF8c2VhcmNofDJ8fGZsYXRlJTIwY2FydHxlbnwwfHx8fDE2ODQ5NTk3MjA&ixlib=rb-4.0.3&q=80&w=400',
  'https://images.unsplash.com/photo-1506748686214-e9df14d4d9d0?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=MnwzNjUyOXwwfDF8c2VhcmNofDJ8fGZzYXRlJTIwY2FydHxlbnwwfHx8fDE2ODQ5NTk3MjA&ixlib=rb-4.0.3&q=80&w=400',
  'https://images.unsplash.com/photo-1506748686214-e9df14d4d9d0?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=MnwzNjUyOXwwfDF8c2VhcmNofDJ8fGZzYXRlJTIwY2FydHxlbnwwfHx8fDE2ODQ5NTk3MjA&ixlib=rb-4.0.3&q=80&w=400',
  'https://images.unsplash.com/photo-1506748686214-e9df14d4d9d0?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=MnwzNjUyOXwwfDF8c2VhcmNofDJ8fGZzYXRlJTIwY2FydHxlbnwwfHx8fDE2ODQ5NTk3MjA&ixlib=rb-4.0.3&q=80&w=400',
];
...
const Home = () => {
  ...
  scrollY.on('change', (latest) => {
    console.log('On Scroll Y: ', latest);
  });
  ...
  return (
    <div>
      ...
      >
        <motion.ul className="h-20 w-20 rounded-full bg-yellow-600">
          <li className="h-6 w-2 rounded bg-blue-600"></li>
          <li className="h-6 w-2 rounded bg-blue-600"></li>
          <li className="h-6 w-2 rounded bg-blue-600"></li>
          <li className="h-6 w-2 rounded bg-blue-600"></li>
          <li className="h-6 w-2 rounded bg-blue-600"></li>
